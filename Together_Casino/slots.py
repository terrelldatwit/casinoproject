...
class SlotsGame(QWidget):
    ...
    def setup_ui(self):
        ...
        stats_layout.addWidget(QLabel("<b>Simulation Statistics:</b>").setStyleSheet("font-size: 16px; margin-bottom: 5px;"))
        ...
        stats_layout.addWidget(self.total_bet_label)
        stats_layout.addWidget(self.total_won_label)
        stats_layout.addWidget(self.rtp_label)
        stats_layout.addWidget(self.house_edge_label)
    ...
    def save_user(self):
        try:
            ...
            # If no entry exists, insert a new one
                ...
                self.cur.execute("""
                    INSERT INTO Slots (player_name, number_of_bets, bet_amount, wins, losses, money_won, session_number)
                    VALUES (?, ?, ?, ?, ?, ?, ?)
                """, (
                    self.full_name,
